...
INSERT INTO tb_plano values (nextval('sq_plano'), 'Pro Gamer', 'Plano limitado com acesso a alguns jogos.', 2.99, 'sim', null, cast('2022-01-01' as timestamp));
INSERT INTO tb_plano values (nextval('sq_plano'), 'Elite', 'Acesso ilimitado a plataforma e maior peso nas decisões da comunidade.', 9.99, 'sim', null, cast('2022-01-01' as timestamp));
